%% DOCUMENT TITLE
%
% same as whereChunks but uses rowAlmostEmpty instead of rowIsEmpty
%   --> rowAlmostEmpty defines rows as empty if they have 2 or less items
%
% INTRODUCTORY TEXT
...
function output = whereChunks2(t)
